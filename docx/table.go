...
// SetAttrs устанавливает переданные атрибуты элемента.
// Атрибуты передаются в виде среза xml.Attr
// Переданный срез атрибутов присваивается полю Attrs элемента TableItem.
// Example usage:
//
//	attrs := []xml.Attr{
